...
def swap_token1_for_token2():
  print("Building swap Token 1 for Token 2 atomic transaction group...")
  ...
  # Transaction to send Token 1 to Escrow
  ...
  print(f"Swap Token 1 for Token 2 transaction sent from User successfully! Tx ID: https://testnet.algoexplorer.io/tx/{tx_id}")
...
if __name__ == "__main__":
  ...
  get_token2_refund(STATE_MANAGER1_INDEX)