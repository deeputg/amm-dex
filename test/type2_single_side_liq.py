...
# Make Escrow LogicSig
program = base64.b64decode(ESCROW_LOGICSIG)
escrow_lsig = transaction.LogicSig(program)
...
def add_liquidity():
  ...
  # Transaction to burn TOKEN2 from escrow
  ...
  stxn_3 = transaction.LogicSigTransaction(txn_3, escrow_lsig)
...
if __name__ == "__main__":
  ...
  get_token2_refund(STATE_MANAGER0_INDEX)
  get_token2_protocol_refund()
  get_ss2_liquidity_token_refund(SS2_LIQUIDITY_TOKEN_INDEX)